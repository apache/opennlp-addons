...
Optional OpenNLP components, published as `org.apache.opennlp.addons:predicate-annotators`.

Build and run the module tests from the repository root:

```sh
mvn -pl predicate-annotators -am verify -Dopennlp.forkCount=1
```
...
Migrated from [ai-pipestream/opennlp OPENNLP-XXXX-predicate-annotators](https://github.com/ai-pipestream/opennlp/tree/989e8cd0a2cb5fa3900789ef3e986e599fbb2bac).
