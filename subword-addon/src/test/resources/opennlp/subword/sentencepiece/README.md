...
pip install sentencepiece==0.2.2 protobuf==7.36.1
...
The generator checks for SentencePiece 0.2.2 and protobuf 7.36.1. It disables
input shuffling and parallel training so repeated runs produce the same files.
